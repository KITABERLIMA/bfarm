import 'package:bfarm_mobileapp/home%20pages/TotalTagihanLangganan1.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TagihanLangganan1(),
    );
  }
}

class TagihanLangganan1 extends StatelessWidget {
  final int selectedItems;

  const TagihanLangganan1({Key? key, this.selectedItems = 0}) : super(key: key);
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const TotalTagihanLangganan1()),
                );
              },
