import 'package:bfarm_mobileapp/home%20pages/PembayaranLangganan.dart';
...
void main() {
  runApp(const Subscrabe());
}

class Subscrabe extends StatelessWidget {
  const Subscrabe({Key? key}) : super(key: key);
...
class _BFarmHomePageState extends State<BFarmHomePage> {
  ...
  static final List<Widget> _widgetOptions = <Widget>[
    ...
    langganan.Langganan(), // Index 3: Langganan page
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PembayaranLangganan(),
                        ),
                      );
                    },
