import 'package:bfarm_mobileapp/home%20pages/PembayaranBerhasil2.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TotalTagihanLangganan1(),
    );
  }
}

class TotalTagihanLangganan1 extends StatelessWidget {
  const TotalTagihanLangganan1({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const TotalPayment(totalAmount: 285000),
          Padding(
          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const PembayaranBerhasil2()),
              );
            },
            child: Container(
              width: double.infinity,
